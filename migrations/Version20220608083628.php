 ...
 */
final class Version20220608083628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE poll ADD options LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE poll DROP options, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(2048) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE answers answers LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:json)\'');
